...
class Watermark
{
  ...
  var $h_dst;// 新图句柄
  var $h_mask;// 水印句柄
  var $img_create_quality = 75;// 图片生成质量
  ...
  var $mask_w;// 水印宽
  var $mask_h;// 水印高
  var $mask_font_color = "green";// 水印文字颜色
  ...
  */
  ...
  /**
  * 设置图片生成路径1Y0-973 510-305 190-833   *
       ...
       else
       {
               switch($this->mask_position)
           {
               ...
               case 2:
                   // 左下
                   $this->mask_pos_x = $this->mask_offset_x + $this->img_border_size;
                   $this->mask_pos_y = $this->dst_h - $this->mask_h - $this->mask_offset_y -

$this->img_border_size;
                   break;

               case 3:
                   // 右上
                   $this->mask_pos_x = $this->dst_w - $this->mask_w - $this->mask_offset_x -
  ...
  */
  function _setNewImgSize($img_w, $img_h=null)
  {
       ...
       if(1 == $num)
       {
           ...
           $this->fill_w = round($this->src_w * $this->img_scale / 1) - $this->img_border_size*2;
          $this->fill_h = round($this->src_h * $this->img_scale / 1) - $this->img_border_size*2;
