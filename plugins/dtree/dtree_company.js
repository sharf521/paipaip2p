...
function dTree(objName,url) {
	...
	this.icon = {
		...
		line				: url+'img/empty.gif',

		join				: url+'img/empty.gif',

		joinBottom	: url+'img/empty.gif',

		plus				: url+'img/nolines_plus.gif',

		plusBottom	: url+'img/nolines_plus.gif',

		minus				: url+'img/nolines_minus.gif',

		minusBottom	: url+'img/nolines_minus.gif',
...
dTree.prototype.node = function(node, nodeId) {
	...
	if (this.config.useIcons) {
		...
		str += '<img  title="µã»÷Ô¤ÀÀ"  border=0 id="i' + this.obj + nodeId + '" src="' + ((node._io) ? node.iconOpen : node.icon) + '" alt="" />';
