...
dTree.prototype.node = function(node, nodeId) {
	...
	if (this.config.useIcons) {
		...
		str += '<a href="../index.php/'+nodeId+',0" target="_blank" style="cursor:move" ><img  title="µã»÷Ô¤ÀÀ"  border=0 id="i' + this.obj + nodeId + '" src="' + ((node._io) ? node.iconOpen : node.icon) + '" alt="" /></a>';
