...
//$temlate_dir = "themes/{$_G['con_template_name']}_member";
//liukun add for bug 473 end
$temlate_dir = "themes/member";
$magic->template_name = '';
$magic->compile_dir='./data/compile/user';
...
# 用户中心处理数据的地方	
	...
	//所有在mall_interface中的请求都不需要判断是否登录，因为可能是外部直接调用的合法请求
	if(in_array($_U['query_type'], $mall_interface)){
...
$_U['con_template_name']=$_G['con_template_name'];
//$magic->assign("con_template_name",$con_template_name);
$magic->assign("_U",$_U);
