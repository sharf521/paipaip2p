	...
	<div class="user_right">
		<div class="user_right_menu">
			...
			<ul class="list-tab clearfix">
				...
				<!--<li {if $_U.query_type=="tender_reply"} class="cur"{/if}><a href="{$_U.query_url}/tender_reply">贷款者评价</a></li>-->
			</ul>
			...
			<ul class="list-tab clearfix">
				...
				<li {if $_U.query_type=="borrow_vouch"} class="cur"{/if}><a href="{$_U.query_url}/borrow_vouch">担保的借款</a></li>
				 -->
				<li {if $_U.query_type=="loanermsg"} class="cur"{/if}><a href="{$_U.query_url}/loanermsg">投资者评价</a></li>
		...
		<!--投资者评价 开始-->
		<div class="well" style="height:30px; padding-top:7px; display:none;"> 
		...
		<table  border="0"  cellspacing="1" class="table table-striped  table-condensed" style="width:100%">
			  <form cur="" method="post">
				...
				{list module="comment" var="loop" function ="GetList" showpage="3" user_id="0" keywords="request" dotime1="request" dotime2="request" }
				{foreach from="$loop.list" item="item"}
				<tr {if $key%2==1} class="tr1"{/if}>
					<td  >{$item.name}</td>
					<td  >{$item.username}</td>
    ...
    {/article}
		...
		<table  border="0"  cellspacing="1" class="table table-striped  table-condensed" style="width:100%">
			  <form cur="" method="post">
				...
				{list module="comment" var="loop" function ="GetListmy" showpage="3" user_id="0" keywords="request" dotime1="request" dotime2="request" }
				{foreach from="$loop.list" item="item"}
				<tr {if $key%2==1} class="tr1"{/if}>
					<td  >{$item.name}</td>
					<td  >{$item.username}</td>
