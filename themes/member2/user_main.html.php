...
<div class="wrap950 " >
	...
	<div class="user_right ">
		...
		<div class="alert_alert-error" id="user_amange">
			...
			<a class="a01">{$_G.system.con_webname}</a><a>提醒你：你还没有进行实名认证。</a>
		...
		{/if}
			<div class="user_right_lmain">
				...
				<div class="user_right_txt">
					...
					<a href="index.php?user&q=code/user/avatar" ><font color="#2ea7e0">[更换头像]</font></a>
				</div>
					<ul>
                                            <li class="user_right_txt_a"><div class="floatl"><span >信用等级：</span></div><a style="float: left;" href="/index.php?user&q=code/user/credit">{$_U.user_cache.credit|credit}</a><font color="#2ea7e0">{$_U.user_cache.credit}分</font>
						...
						<li>   
                                                    ...
                                                    <span style="color:#2ea7e0"> 信用额度：<font size="2">￥{$acc.credit|default:0}</font>    </span>
						...
						<li><span>系统告知：</span><a href="/index.php?user&q=code/message"><font color="#2ea7e0">{$_U.user_cache.message}</font> 封未读信息</a>&nbsp; &nbsp; <a href="/index.php?user&q=code/user/request">{$_U.user_cache.friends_apply} 个好友邀请</a>
                                                <a href="/index.php?user&q=code/account/recharge_new"><font color="#2ea7e0">[账号充值]</font></a>
                                                {if in_array("credit", $biaotype_list) }   
                                                <a href="/index.php?user&q=code/borrow/limitapp&type=credit"><font color="#2ea7e0">[额度申请]</font></a>
                                                {/if}
                                                </li>
					</ul>
				</div>
                ...
                <div class="user_right_info">
                    ...
                    <div class="content">
                        <ul>
                            ...
                            <li><span>客服名称：</span><span>{$var.username}</span></li>
                            <li><span>客服QQ：</span><a target="_blank" href="http://wpa.qq.com/msgrd?v=1&uin={$var.qq}&site=qq&menu=yes" > <img  src="http://wpa.qq.com/pa?p=1:{$var.qq}:1" alt="点击这里给我发消息" title="点击这里给我发消息">
                                </a>
                            </li>
                            <li><span>客服电话：</span><span>{$var.phone}</span></li>
                        </ul>
                    </div>
                </div>
                {/if}
...
<table >
  ...
  <div class="title"><span>待收待还详情</span></div>
  <table>
  <tr>
  ...
  <div class="title"><span>流转标详情</span></div>
  <table>
  <tr>
  ...
  {/if}
  <!--  add for bug 274 end -->
  <div class="title"><span>额度详情</span></div>
  <table>
  <tr>
  ...
  <div class="title"><span>充值奖励详情</span></div>
  <table>
  <tr>
...
{/literal}
  ...
  */
  ...
  <div class="title"><span>返还信息</span></div>
  <table>
  <tr>
