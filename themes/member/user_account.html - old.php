		...
		<div id="ban">
						...
						<table width="100%" cellpadding="3" cellspacing="3">
						 ...
						 <tr>
						   ...
						   <td  width="160">
                                                       <input type="radio" name="payment1" value="CCB_27"/>
						 ...
						 <tr>
						   <td><input type="radio" name="payment1" value="PSBC_51"/>
						   <img src="../data/bank/HZBANK.jpg" border="0"/></td>
						   <td width="160">
                                                       <input type="radio" name="payment1" value="BOC_45">
						 ...
						 <tr>
						   <td><input type="radio" name="payment1" value="GDB_52" />
						   <img src="../data/bank/ningbobank.jpg" border="0"/></td>
						   <td><input type="radio" name="payment1" value="SPDB_16">
						   <img src="../data/bank/pf.jpg" border="0"/></td>
						   <td><input type="radio" name="payment1" value="SDB_50">
						   <img src="../data/bank/pinganbank.jpg" border="0"/></td>
					...
					<!--
                     <table width="100%" cellpadding="3" cellspacing="3">
						 ...
						 <tr>
                              <td width="150"><input type="radio" name="payment1" value="ICBC_t" />
                                <img src="../data/bank/ICBC_OUT.gif" border="0"/></td>
						   <td width="150">
                              <input type="radio" name="payment1" value="BOC_t">
						   <img src="../data/bank/BOC_OUT.gif" border="0"/>   </td>
						   <td  width="150">
                          <input type="radio" name="payment1" value="CCB_t"/>
                               <img src="../data/bank/CCB_OUT.gif" border="0"/></td>

						 </tr>
						 <tr>
						   <td><input type="radio" name="payment1" value="ABC_t"/>
						   <img src="../data/bank/ABC_OUT.gif" border="0"/></td>
						   <td>
                                                       <input type="radio" name="payment1" value="CMB_t"/>
						   <img src="../data/bank/CMB_OUT.gif" border="0"/>
                                                       </td>
						   <td><input type="radio" name="payment1" value="GDB_t" />
						   <img src="../data/bank/GDB_OUT.gif" border="0"/></td>

						 </tr>
						 <tr>
						   <td><input type="radio" name="payment1" value="CMBC_t"/>
						   <img src="../data/bank/CMBC_OUT.gif" border="0"/></td>
						   <td><input type="radio" name="payment1" value="CEB_t"/>
						   <img src="../data/bank/CEB_OUT.gif" border="0"/></td>
						   <td><input type="radio" name="payment1" value="CIB_t"/>
						   <img src="../data/bank/CIB_OUT.gif" border="0"/></td>

						 </tr>
						 <tr>
						   <td><input type="radio" name="payment1" value="PSBC_t"/>
						   <img src="../data/bank/yz.jpg" border="0"/></td>
						   <td><input type="radio" name="payment1" value="HXB_t"/>
                                                   <img src="../data/bank/hx.jpg" border="0"/></td>
						   <td><input type="radio" name="payment1" value="COMM_t"/>
						   <img src="../data/bank/COMM_OUT.gif" border="0"/></td>
						 </tr>
						 <tr>
						   <td><input type="radio" name="payment1" value="CITIC_t"/>
						   <img src="../data/bank/CITIC_OUT.gif" border="0"/></td>
						   <td><input type="radio" name="payment1" value="SPDB_t">
						   <img src="../data/bank/pf.jpg" border="0"/></td>
						   <td><input type="radio" name="payment1" value="SDB_t">
						   <img src="../data/bank/SZFZ_OUT.gif" border="0"/></td>
						 </tr>
						 <tr>
						   <td><input type="radio" name="payment1" value="BCCB_t"/>
						   <img src="../data/bank/bjbank.jpg" border="0"/></td>
						   <td><input type="radio" name="payment1" value="CBHB_t">
						   <img src="../data/bank/bhbank.jpg" border="0"/></td>
						   <td><input type="radio" name="payment1" value="HKBEA_t">
						   <img src="../data/bank/dybank.jpg" border="0"/></td>
						 </tr>
						  <tr>
						   <td><input type="radio" name="payment1" value="HCCB_t"/>
						   <img src="../data/bank/hzbank.jpg" border="0"/></td>
						   <td><input type="radio" name="payment1" value="NJCB_t">
						   <img src="../data/bank/njbank.jpg" border="0"/></td>
						   <td><input type="radio" name="payment1" value="NBCB_t">
						   <img src="../data/bank/nbbank.jpg" border="0"/></td>
						 </tr>
						  <tr>
						   <td><input type="radio" name="payment1" value="SZPAB_t"/>
						   <img src="../data/bank/pabank.jpg" border="0"/></td>
						   <td><input type="radio" name="payment1" value="BOS_t">
						   <img src="../data/bank/shbank.jpg" border="0"/></td>
						   <td><input type="radio" name="payment1" value="SHRCB_t">
						   <img src="../data/bank/shncbank.jpg" border="0"/></td>
						 </tr>
						  <tr>
						   <td><input type="radio" name="payment1" value="BJRCB_t"/>
						   <img src="../data/bank/bjncbank.jpg" border="0"/></td>
						   <td><input type="radio" name="payment1" value="CZCB_t">
						   <img src="../data/bank/czbank.jpg" border="0"/></td>
